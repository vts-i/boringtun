...
pub struct Tunn {
    handshake: spin::Mutex<HandshakeData>,
...
impl Tunn {
    ...
    pub fn new(
        ...
        let tunn = Tunn {
            handshake: spin::Mutex::new(HandshakeData {
    ...
    fn encapsulate_with_guard<'a>(
        &self,
        hs_data: Option<&mut spin::MutexGuard<HandshakeData>>,
        src: &[u8],
        dst: &'a mut [u8],
    ) -> TunnResult<'a> {
    ...
    fn format_handshake_initiation_with_guard<'a>(
        &self,
        hs_data: &mut spin::MutexGuard<HandshakeData>,
        dst: &'a mut [u8],
        force_resend: bool,
    ) -> TunnResult<'a> {
